...
class Easy_Tag_And_Tracking_Id_Inserter_Public {
	...
	public function __construct( $plugin_name, $version ) {
		...
		$this->easy_tag_and_tracking_id_inserter_setting_google_webmaster = get_option('easy_tag_and_tracking_id_inserter_webmaster');
		$this->easy_tag_and_tracking_id_inserter_setting_google_analytical = get_option('easy_tag_and_tracking_id_inserter_analytical');
